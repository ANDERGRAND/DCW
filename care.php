        ...
        <div class="content">
            <main>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM produkty WHERE idKategorii=1 OR idKategorii=2 OR idKategorii=3 OR idKategorii=4 OR idKategorii=5 OR idKategorii=6";
                    ...
                    if ($result->num_rows > 0)
                    {
                        while ($row=$result->fetch_array())
                        {
                            ...
                            echo '<a href="details.php?id='.$id.'&b=care">';
                            echo '<div class="slot">';
